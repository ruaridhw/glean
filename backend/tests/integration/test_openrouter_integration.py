...
class TestOpenRouterConnectivity:
    def test_list_models_returns_results(self, openrouter_api_key: str, openrouter_smoke_model: str) -> None:
    ...
    def test_default_model_exists_in_catalogue(self, openrouter_api_key: str, openrouter_smoke_model: str) -> None:
...
class TestOpenRouterChat:
    def test_simple_completion(self, openrouter_api_key: str, openrouter_smoke_model: str) -> None:
